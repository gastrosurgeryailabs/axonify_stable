...
export const quizCreationSchema = z.object({
    ...
    explanationPrompt: z.string().min(10, {message: "Explanation prompt must be at least 10 characters long"}).optional().default("Provide clear, concise explanations for why the answer is correct. Include relevant facts and context that help understand the concept."),
