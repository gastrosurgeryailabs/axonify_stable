...
export async function POST(req: Request) {
    try {
        ...
        const system_prompt = "You are a social media expert who creates engaging YouTube video descriptions that drive engagement and discovery through SEO optimization. DO NOT include any placeholder URLs or quiz links - these will be added automatically by the system.";
...
Format the response in a way that's ready to be used as a YouTube video description, with clear sections and formatting. The quiz link will be automatically added by the system.`;
