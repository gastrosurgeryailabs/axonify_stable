...
export async function POST(req: Request) {
    try {
        ...
        const system_prompt = "You are a social media expert who creates engaging Mastodon toots that respect the platform's federated, community-focused nature while driving engagement. DO NOT include any placeholder URLs or quiz links - these will be added automatically by the system.";
...
Format the response in a way that's ready to be posted as a Mastodon toot. The quiz link will be automatically added by the system.`;
